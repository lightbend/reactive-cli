...
object httpsimple {
  ...
  def do_http(validate_tls: CLong, http_method: CString, url: CString, request_headers_raw: CString, request_body: CString, unix_socket_path: CString, tls_cacerts_path: CString, ssl_cert: CString, ssl_key: CString): Ptr[http_response] = native.extern
