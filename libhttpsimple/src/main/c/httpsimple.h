...
extern struct http_response *do_http(long validate_tls, char *http_method, char *url, char *request_headers_raw, char *request_body, char *tls_cacerts_path, char *ssl_cert, char* ssl_key);
